...
const templateConfig: TemplateConfig = {
  ...
  seo: {
    title: "UrbanRoots",
    description: "Find Your Tribe Wherever You Go",
  },
  ...
  appStoreLink: "https://urbanrootsdownload.vercel.app/",
  googlePlayLink:
    "https://urbanrootsdownload.vercel.app/",
  footer: {
    legalLinks: {
    ...
    socials: {
      instagram: "https://instagram.com/teamurbanroots",
      facebook: "https://instagram.com/teamurbanroots",
      twitter: "https://instagram.com/teamurbanroots",
    },
    links: [
  ...
  home: {
    ...
    faq: {
      ...
      qa: [
        {
          question: "How can I create an account on your app?",
          answer:
        ...
        },
        {
          ...
          answer:
            "We accept a variety of payment methods to ensure convenience for our customers. These include major PayPal, Apple Pay, PhonePay and Google Pay. For more details, visit our Payments page.",
        },
        {
          question: "How can I track my booking history?",
          answer:
            "You can use the profile page in the app to redirect to your booking history page however once the booking is confirmed the UrbanRoots App Team will send you a confirmation email for the same.",
        },
        {
          question: "How can I host an event through your app?",
          answer:
            "Just redirect to the home page of the app, there you will find a plus icon, on clicking you will be redirected to the Create Event page where you can fill in your event details to be hosted and you will get a confirmation from the team when it is done.",
        },
      ],
    },
    header: {
      ...
      subtitle:
        "Streamline your tasks, boost your productivity, and accomplish more every day. Unlock a world of possibilities with our cutting-edge mobile application and Find Your Tribe Wherever You Go",
      screenshots: [
        "/screenshots/1.png",
        "/screenshots/2.png",
        "/screenshots/3.png",
      ],
      rewards: ["Social Platform", "Product of the day"],
      ...
      plans: [
        {
          title: "Basic Plan",
          price: "₹50/month",
          rows: ["Access to basic features", "5 free bookings", "Host 2 events/month"],
        },
        {
          title: "Standard Plan",
          price: "₹150/month",
...
Welcome to UrbanRoots (the "App"). UrbanRoots ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and share your personal information when you use our App.
...
UrbanRoots App Team \n
Instagram - @teamurbanroots \n
Email - teamurbanroots@gmail.com
...
This Cookies Policy explains how UrbanRoots ("we," "our," or "us") uses cookies and similar technologies to recognize you when you visit our app, [Your App Name] (the "App"). It explains what these technologies are and why we use them, as well as your rights to control their use.
...
Welcome to UrbanRoots (the "App"). These Terms and Conditions ("Terms") govern your use of the App provided by UrbanRoots ("we," "our," or "us"). By accessing or using our App, you agree to be bound by these Terms. If you do not agree to these Terms, please do not use the App.

## Use of the App

### 1. Eligibility
To use our App, you must be at least 16 years old and capable of entering into a legally binding agreement. By using the App, you represent and warrant that you meet these eligibility requirements.
...
### 1. Ownership
All content and materials available on the App, including but not limited to text, graphics, logos, and software, are the property of UrbanRoots or its licensors and are protected by intellectual property laws.
...
To the fullest extent permitted by law, UrbanRoots shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses, resulting from:
